...
In shallow flows, there is a coexistence of small-scale 3D turbulence, mainly generated by the friction on the bottom, and large-scale 2D turbulence. The proposed model uses a turbulence model to account for the effects of the former and resolves the latter. This approach is often called depth averaged URANS simulation or even depth averaged LES simulation.
