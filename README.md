...
<figure style="text-align: center;">
  ...
  <figcaption>Figure 7. Numerical simulation of a double shear layer using a 1st, 3rd and 5th order schemes. Top: vorticity field. Bottom: energy cascade.</figcaption>
</figure>
