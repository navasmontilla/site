...
<figure style="text-align: center;">
  ...
  <figcaption>Figure 12. Configuration of a channel with lateral cavities.</figcaption>
</figure>

<figure style="text-align: center;">
  <img src="github_site/cavities_turb.png" width="80%" alt="my alt text"/>
  <figcaption>Figure 13. Experimental and computed water surface elevation evolution in time at points E3, E4 and E5 without (left) and with turbulence model (right).</figcaption>
</figure>
