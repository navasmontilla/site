...
Turbulence modelling is of practical application when simulating the flow interaction with solid obstacles such as bridge piers and groynes, or even with strong variations in the bed elevation and bed friction. Figure 10 shows the simulation of a shallow water flow over a [submerged conical island](http://coastal.usc.edu/currents_workshop/problems/prob1.html). Only when including a suitable turbulence model, the velocities in the wake are properly predicted and there is a stable periodicity in the shedding of von-Karman vortices.
...
<figure style="text-align: center;">
  ...
  <figcaption>Figure 11. Configuration of a channel with lateral cavities.</figcaption>
</figure>

<figure style="text-align: center;">
  <img src="github_site/cavities_turb.png" width="80%" alt="my alt text"/>
  <figcaption>Figure 12. Experimental and computed water surface elevation evolution in time at points E3, E4 and E5 without (left) and with turbulence model (right).</figcaption>
</figure>
